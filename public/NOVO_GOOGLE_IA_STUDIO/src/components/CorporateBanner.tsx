  ...
  return (
    <section className="py-12 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl shadow-xl flex flex-col md:flex-row items-center cursor-pointer group" onClick={onNavigate}>
          ...
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#182333] via-[#182333]/90 to-[#182333]/40"></div>
          </div>
          
          {/* Content */}
          <div className="relative z-10 p-8 sm:p-12 md:p-16 flex-1 text-left flex flex-col justify-center w-full">
            ...
            <div className="inline-flex items-center gap-2 text-white font-bold group-hover:text-[#FFC72C] transition-colors">
              <span>Conheça as Soluções Corporativas</span>
